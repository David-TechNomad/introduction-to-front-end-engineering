    ...
    steps:
      ...
      - name: Deploy # 将打包内容发布到 github page
        ...
        with:  # 自定义环境变量
          ...
          BRANCH: master
          FOLDER: dist
          REPOSITORY_NAME: David-TechNomad/David-TechNomad.github.io # 这是我的 github page 仓库
...
具体详情可以参考一下我的 demo 项目 **[github-actions-demo](https://github.com/David-TechNomad/github-actions-demo)**。
...
如果还是不懂，建议看一下我的 [demo](https://github.com/David-TechNomad/github-actions-aliyun-demo)。
